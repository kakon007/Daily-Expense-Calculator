...
public class Earn extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listEarn=(ListView) findViewById(R.id.listEarn);
        db = new DatabaseHelper(this);


        tvEarn = (TextView) findViewById(R.id.tvEarn);

        int earn = db.Total("table_earn");
        String ss_earn = addCommas(""+earn);
        tvEarn.setText("Total: "+ss_earn);





        Cursor cursor=db.getEarn();
        ...
        adapter = new CustomAdapter(Earn.this, arrayList);
        listEarn.setAdapter(adapter);
        ...
        public View getView(final int position, View view, ViewGroup viewGroup) {
            ...
            bDelete.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    db = new DatabaseHelper(Earn.this);

                    db.deleteFromTable("table_earn", ""+id);
                    Toast.makeText(getApplicationContext(), "Deleted!",  Toast.LENGTH_LONG).show();
                    myArrayList.remove(position);
                    adapter.notifyDataSetChanged();
                    listEarn.invalidateViews();
